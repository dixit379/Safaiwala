...
const AddEmployee = () => {
    ...
    return (
        <form onSubmit={onSubmitHandler} className='m-5 w-full'>
            ...
            <p className='mb-3 text-lg font-medium'>Add Serviceman</p>
            ...
            <div className='bg-white px-8 py-8 border rounded w-full max-w-4xl max-h-[80vh] overflow-y-scroll'>
                <div className='flex items-center gap-4 mb-8 text-gray-500'>
                    ...
                    <p>Upload Serviceman <br /> picture</p>
                </div>
                ...
                <div className='flex flex-col lg:flex-row items-start gap-10 text-gray-600'>
                    ...
                    <div className='w-full lg:flex-1 flex flex-col gap-4'>
                        ...
                        <div className='flex-1 flex flex-col gap-1'>
                            <p>Fees</p>
                            <input onChange={e => setFees(e.target.value)} value={fees} className='border rounded px-3 py-2' type="number" placeholder='Serviceman fees' required />
                        </div>
                ...
                {/* <div>
                    <p className='mt-4 mb-2'>About Serviceman</p>
                ...
                <button type='submit' className='bg-primary px-10 py-3 mt-4 text-white rounded-full'>Add Serviceman</button>
